...
class PDFViewer {
  ...
  constructor(options) {
    const viewerVersion =
      typeof PDFJSDev !== "undefined" ? PDFJSDev.eval("BUNDLE_VERSION") : null; // idk what this is but it should ouput bundle version of 4.5.136
    if (version !== "4.5.136") { // replaced viewerVersion with literal "4.5.136" to bypass version check 
      throw new Error(
